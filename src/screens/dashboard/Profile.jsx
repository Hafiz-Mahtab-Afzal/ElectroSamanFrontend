...
const Profile = () => {
  ...
  return (
    <div>
      <h1 className='text-4xl text-green-600 font-bold pt-6 text-green text-center'>Profile</h1>

      {/* tailwind work */}
      <div className="max-w-4xl flex items-center -translate-y-16 h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
  {/*Main Col*/}
  <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
    <div className="p-4 md:p-12 text-center lg:text-left">
      ...
      <h1 className="text-3xl font-bold pt-8 lg:pt-0">{first_name}  {last_name}</h1>
